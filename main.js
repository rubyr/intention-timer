...
function timer(){
    ...
    var timer = setInterval(function(){
        ...
        if (hourForm == 0 && minForm < 10 && secForm < 10){
          ...
          document.getElementById('done').innerHTML= `0${minForm.toFixed(0)}:${secForm.toFixed(0)}`; //0M:SS
        } else if (hourForm == 0 && minForm >= 10 && secForm < 10){
          ...
          document.getElementById('done').innerHTML= `0${hourForm.toFixed(0)}:${minForm.toFixed(0)}:${secForm.toFixed(0)}`;//0H:MM:SS
        } else if (hourForm > 0 && hourForm < 10 && minForm < 10 && secForm >= 10){
          document.getElementById('done').innerHTML= `0${hourForm.toFixed(0)}:0${minForm.toFixed(0)}:${secForm.toFixed(0)}`;//0H:0M:SS
        } else {
